...
public class Explodable : MonoBehaviour
{
    ...
    public float FragmentsLifeTime = 5;
    public bool DestroyParentObject=false;
    ...
    private void generateFragments()
    {
        ...
        switch (shatterType)
        {
            ...
            case ShatterType.Voronoi:
                //fragments =
                 PV.RPC("GenerateVoronoiPieces",RpcTarget.AllBuffered,extraPoints, subshatterSteps) ;
                //SpriteExploder.GenerateVoronoiPieces(gameObject, extraPoints, subshatterSteps);
                break;
            default:
       ...
       /* foreach (GameObject p in fragments)
        {
            if (p != null)
            {
                ...
                if (FragmentsLifeTime!=0)
                    p.GetComponent<DestroyFragments>().LifeTime = FragmentsLifeTime;
            }
        }*/
