...
public class ExplodableEditor : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        myTarget.FragmentsLifeTime = EditorGUILayout.FloatField("Fragments Life Time", myTarget.FragmentsLifeTime);
        myTarget.DestroyParentObject=EditorGUILayout.Toggle("Destroy Parent Object", myTarget.DestroyParentObject);
